  ...
  return (
    <div className="w-full max-w-[520px] bg-white rounded-2xl shadow-md p-5 sm:p-6 md:p-10">
      ...
      <p className="text-center text-sm text-gray-500 mb-7 sm:mb-8">
        Create an account to manage your enrollments and get updates.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <Link
            ...
            className="text-[#3491E8] text-sm hover:underline"
          >
            Forgot password?
          </Link>
        </div>
        ...
        <label className="flex items-start gap-3 cursor-pointer">
          <input
            ...
            className="w-5 h-5 mt-0.5 rounded border-gray-300 text-[#3491E8] focus:ring-[#3491E8] accent-[#3491E8] cursor-pointer shrink-0"
          />
          <span className="text-sm text-gray-600 leading-relaxed">
            By clicking this button, you agree to our{" "}
            <Link
              href="/terms"
              className="text-[#3491E8] hover:underline font-medium"
            >
              Terms
            </Link>{" "}
