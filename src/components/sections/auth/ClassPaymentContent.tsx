...
export default function ClassPaymentContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Processing class payment:", { paymentMethod, ...payment });
  ...
  return (
    <div className="w-full max-w-[1100px] flex flex-col lg:flex-row gap-4 md:gap-5 lg:gap-6 items-start">
      {/* ── Left card — Order Summary (smaller, heavy shadow) ── */}
      <div
        className="w-full lg:w-[300px] bg-white rounded-2xl p-5 sm:p-6 shrink-0"
      ...
      >
        ...
        <p className="text-base font-bold text-gray-900">Total:{"  "}120</p>
      </div>

      {/* ── Right card — Payment Method (wider) ── */}
