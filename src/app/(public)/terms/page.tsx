export default function TermsOfUsePage() {
  return (
    <div className="min-h-screen bg-[#E8EDF2] py-6 sm:py-10 lg:py-14 px-3 sm:px-6">
      ...
      <div className="max-w-[1256px] mx-auto rounded-2xl sm:rounded-3xl border-[8px] sm:border-[12px] lg:border-[16px] border-[#3491E833] overflow-hidden" style={{ background: "#3491E814" }}>
        {/* Navy header banner with confetti texture */}
        <div className="relative overflow-hidden bg-header">
          <div
            ...
            style={{
              ...
              `,
              backgroundSize: "20px 20px, 33px 33px",
              backgroundPosition: "0 0, 10px 10px",
            }}
          />
          <div className="relative z-10 text-center py-10 sm:py-14 px-4">
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl text-white font-bold">
              Privacy Policy
            </h1>
        ...
        {/* Blue accent strip between header and content */}
        <div className="h-1.5 bg-[#3491E8]" />

        {/* Content area */}
        <div className="px-4 py-8 sm:px-10 sm:py-12 lg:px-14 pb-10 sm:pb-[60px]">

          <section className="mb-10 last:mb-0">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 uppercase mb-3">
              No Refunds
            </h2>
          ...
          <section className="mb-10 last:mb-0">
            ...
            <ol className="list-decimal list-inside text-sm sm:text-base text-gray-700 leading-relaxed space-y-2 ml-2">
              <li>Not to use VOTING SYSTEM for illegal purposes;</li>
              <li>
                Not to use VOTING SYSTEM for chain letters, junk mail, unlawful &ldquo;spamming&rdquo; solicitations (commercial or otherwise) or unlawful bulk communications of any kind, and Not to use VOTING SYSTEM to send an excessive number of communications to the same recipient.
              </li>
            </ol>
          </section>
          ...
          <div className="space-y-6 text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            <p>
              Where Lawsuits May be Brought Subject to the following policy or last paragraphs, any and all lawsuits in any way related to this policy, shall be brought, heard, and decided only in a state or federal court located in Illinois.
            </p>
          </div>
        </div>
      </div>
